...
def call(body) {
  ...
  if (!config.packerAwsRegion) {
    error 'You must provide a packerAwsRegion'
  }

  if (!config.packerAwsAccessCredentialsId) {
    error 'You must provide a packerAwsAccessCredentialsId'
  }
  ...
  def packerSourceRelativePath = config.packerSourceRelativePath ?: '.'
  def packerAwsAccessCredentialsId = config.packerAwsAccessCredentialsId
  def packerAwsRegion = config.packerAwsRegion
...
EOF"""
      ...
      stage('RunTerraformContainer'){
        ...
        withCredentials([
          ...
          [
            $class: 'UsernamePasswordMultiBinding',
            credentialsId: packerAwsAccessCredentialsId,
